node {
	...
	stage('DeployAppTo QA') {
		...
		jiraSendDeploymentInfo environmentId: 'QA', environmentName: 'QA', environmentType: 'testing', serviceIds: [''], site: 'devopscasestudy.atlassian.net', state: 'successful'
	...
	stage('DeployAppTo PROD') {
		...
		jiraSendDeploymentInfo environmentId: 'PROD', environmentName: 'PROD', environmentType: 'testing', serviceIds: [''], site: 'devopscasestudy.atlassian.net', state: 'successful'
