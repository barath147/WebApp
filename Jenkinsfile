node {
	...
	stage('DeployAppTo QA') {
		...
		jiraSendDeploymentInfo environmentId: 'QA', environmentName: 'QA', environmentType: 'testing', serviceIds: ['DOPS-1'], site: 'devopscasestudy.atlassian.net'
	...
	stage('DeployAppTo PROD') {
		...
		jiraSendDeploymentInfo environmentId: 'PROD', environmentName: 'PROD', environmentType: 'production', serviceIds: ['DOPS-1'], site: 'devopscasestudy.atlassian.net'
